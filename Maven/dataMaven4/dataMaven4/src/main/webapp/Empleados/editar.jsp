...
<div>
        ...
        <form class="form-group" action="ServletEmpleadoController?action=actualizar" method="post">
            <div><label>Id</label>
            ...
            <div>
                ...
                <a class="btn btn-danger" href="ServletEmpleadoController?action=regresar">Regresar a lista</a>
            </div>     
        </form>
           </div>
        </div>
